...
const currentBrowserIsChrome = window.chrome
...
async function createEmscriptenModuleInstance(resourceLoader) {
    ...
    if (resourceLoader.bootConfig.resources.runtime.hasOwnProperty(dotnetTimeZoneResourceName)) {
        timeZoneResource = resourceLoader.loadResource(dotnetTimeZoneResourceName, `${window['blazorPath']}/${dotnetTimeZoneResourceName}`, resourceLoader.bootConfig.resources.runtime[dotnetTimeZoneResourceName], 'globalization');
    }
    let icuDataResource;
    if (resourceLoader.bootConfig.icuDataMode !== ICUDataMode.Invariant) {
        ...
        icuDataResource = resourceLoader.loadResource(icuDataResourceName, `${window['blazorPath']}/${icuDataResourceName}`, resourceLoader.bootConfig.resources.runtime[icuDataResourceName], 'globalization');
    }
